...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black">
     <div class="relative fullwidth col-xs-12">
		...
		<fieldset>
		    <legend><h4>Add Student</h4></legend> <br>
			<div class="w3-center"> First Name  <input type="text" name="cname"> </div> 
			<div class="w3-center" > Last Name  <input type="text" name="ccode"></div> <br>
