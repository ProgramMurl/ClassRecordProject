            ...
            <div class="col-auto mb-3">
              <div class="card" style="width: 24rem;">
                ...
                <div class="card-body">
                  <!-- <h5 class="card-title">Card title</h5>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> -->
                  <a href="submitgrade.php?id=<?php echo $_GET['id']?>" class="btn">Submit Grades</a>
                </div>
              </div>
            </div>
            <div class="col-auto mb-3">
              <div class="card" style="width: 24rem;">
                ...
                <div class="card-body">
                  <!-- <h5 class="card-title">Card title</h5>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> -->
                  <a href="viewcomputedgrades.php?id=<?php echo $_GET['id']?>" class="btn">Calculate Final Grades</a>
                </div>
              </div>
            </div>
            <div class="col-auto mb-3">
